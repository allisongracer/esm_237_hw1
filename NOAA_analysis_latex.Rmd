---
title: |
  | \vspace{-1.1 cm} ESM 237: Assignment 1  \vspace{-0.5cm}
author: |
  | \vspace{0 cm} *Allison Gracer, Caroline Shepherd, & Trevor Maggart* \vspace{-1.1cm}
date: | 
...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE, include=FALSE, fig.pos = "H", out.extra = "")
```
...
kable(reg_table,
      ...
      caption = "Statistical analysis of the warming trends seen for the average maximum and minimum annual temperatures") %>% 
    add_header_above(c(" " = 1, "Linear Regression" = 2, "Mann-Kendall" = 2), bold = T) %>% 
